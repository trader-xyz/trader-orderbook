...
export const getApprovalStatus = async (
  ...
  switch (asset.type) {
    case 'ERC20':
      ...
      console.log('asset - asset.tokenAddress', asset, asset.tokenAddress)
    ...
    case 'ERC721':
      ...
      const tokenIdApproved =
        ...
        console.log('erc721ApprovedAddressForId', erc721ApprovedAddressForId, exchangeProxyAddressForAsset)
      return {
...
export const generateErc721Order = (
  ...
  console.log('erc721Order', erc721Order);
...
export const generateErc1155Order = (
  ...
  console.log('erc1155Order', erc1155Order)
