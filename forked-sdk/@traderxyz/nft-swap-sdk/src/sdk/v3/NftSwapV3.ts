...
class NftSwapV3 implements INftSwapV3 {
  ...
  public checkIfOrderCanBeFilledWithNativeToken = (
    ...
    if (
      ...
      console.log('decodedAssetData.assetProxyId?.toLowerCase(): ', decodedAssetData.assetProxyId?.toLowerCase());
      console.log('AssetProxyId.ERC20?.toLowerCase(): ', AssetProxyId.ERC20?.toLowerCase())
      return false;
    }
    ...
    console.log('wrappedNativeTokenContractAddress: ', wrappedNativeTokenContractAddress);
