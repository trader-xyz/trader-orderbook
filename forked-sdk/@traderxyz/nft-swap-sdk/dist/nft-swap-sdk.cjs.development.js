...
var getUnixTime = _interopDefault(require('date-fns/getUnixTime'));
require('@ethersproject/address');
var ethers = require('ethers');
var uuid = require('uuid');
var padEnd = _interopDefault(require('lodash/padEnd'));
...
var ZERO_AMOUNT = /*#__PURE__*/bignumber.BigNumber.from(0);
...
})(exports.AssetProxyId || (exports.AssetProxyId = {}));
...
})(exports.SupportedChainIdsV3 || (exports.SupportedChainIdsV3 = {}));
...
})(exports.OrderStatusV3 || (exports.OrderStatusV3 = {}));
...
})(exports.ORDER_BUILDER_ERROR_CODES || (exports.ORDER_BUILDER_ERROR_CODES = {}));
...
})(exports.SupportedTokenTypes || (exports.SupportedTokenTypes = {}));
...
})(exports.RevertReason || (exports.RevertReason = {}));

var TRADER_ADDRESS_IDENTIFIER = '0xBCC02a155c374263321155555Ccf41070017649e';
var INFINITE_TIMESTAMP_SEC = /*#__PURE__*/bignumber.BigNumber.from(2524604400);
...
var generateOrderFromAssetDatas = function generateOrderFromAssetDatas(orderConfig) {
  ...
  var expirationTimeSeconds = expiration ? bignumber.BigNumber.from(getUnixTime(expiration)) : INFINITE_TIMESTAMP_SEC;
  var order = {
...
var convertStringToBN = function convertStringToBN(s) {
  return bignumber.BigNumber.from(s);
};
...
var encodeErc20AssetData = function encodeErc20AssetData(tokenAddress) {
  return bytes.hexConcat([exports.AssetProxyId.ERC20, abi.defaultAbiCoder.encode(['address'], [tokenAddress])]);
};
var decodeErc20AssetData = function decodeErc20AssetData(encodedAssetData) {
  var length = bytes.hexDataLength(encodedAssetData);
  var assetProxyId = bytes.hexDataSlice(encodedAssetData, 0, 4);
  var rest = bytes.hexDataSlice(encodedAssetData, 4);
  var data = abi.defaultAbiCoder.decode(['address'], rest);
...
var encodeErc721AssetData = function encodeErc721AssetData(tokenAddress, tokenId) {
  return bytes.hexConcat([exports.AssetProxyId.ERC721, abi.defaultAbiCoder.encode(['address', 'uint256'], [tokenAddress, tokenId])]);
};
var decodeErc721AssetData = function decodeErc721AssetData(encodedAssetData) {
  var assetProxyId = bytes.hexDataSlice(encodedAssetData, 0, 4);
  var rest = bytes.hexDataSlice(encodedAssetData, 4);
  var data = abi.defaultAbiCoder.decode(['address', 'uint256'], rest);
  var tokenAddress = data[0];
  var tokenId = data[1];
  return {
    assetProxyId: assetProxyId.toLowerCase(),
...
var encodeErc1155AssetData = function encodeErc1155AssetData(tokenAddress, tokenIds, values, callbackData) {
  return bytes.hexConcat([exports.AssetProxyId.ERC1155, abi.defaultAbiCoder.encode(['address', 'uint256[]', 'uint256[]', 'bytes'], [tokenAddress, tokenIds, values, callbackData])]);
};
var decodeErc1155AssetData = function decodeErc1155AssetData(encodedAssetData) {
  var assetProxyId = bytes.hexDataSlice(encodedAssetData, 0, 4);
  var rest = bytes.hexDataSlice(encodedAssetData, 4);
  var data = abi.defaultAbiCoder.decode(['address', 'uint256[]', 'uint256[]', 'bytes'], rest);
  var tokenAddress = data[0];
  var tokenIds = data[1];
  var values = data[2];
...
var encodeMultiAssetAssetData = function encodeMultiAssetAssetData(values, nestedAssetData) {
  return bytes.hexConcat([exports.AssetProxyId.MultiAsset, abi.defaultAbiCoder.encode(['uint256[]', 'bytes[]'], [values, nestedAssetData])]);
};
var decodeMultiAssetData = function decodeMultiAssetData(encodedAssetData) {
  var assetProxyId = bytes.hexDataSlice(encodedAssetData, 0, 4);
  var rest = bytes.hexDataSlice(encodedAssetData, 4);
  var data = abi.defaultAbiCoder.decode(['uint256[]', 'bytes[]'], rest);
  var values = data[0];
...
erc1155EncodingForMultiAssetOrder) {
  ...
  switch (assetData.type) {
    case exports.SupportedTokenTypes.ERC20:
      var erc20AssetData = encodeErc20AssetData(assetData.tokenAddress);
      return erc20AssetData;

    case exports.SupportedTokenTypes.ERC721:
      var erc721AssetData = encodeErc721AssetData(assetData.tokenAddress, bignumber.BigNumber.from(assetData.tokenId));
      return erc721AssetData;

    case exports.SupportedTokenTypes.ERC1155:
  ...
  switch (swappable.type) {
    ...
    case 'ERC1155':
      var zeroExErc1155AssetFormat = {
        ...
        type: exports.SupportedTokenTypes.ERC1155
      };
...
var encodeTypedDataHash = function encodeTypedDataHash(typedData) {
  ...
  return hash._TypedDataEncoder.hash(typedData.domain, types, typedData.message);
};
...
var hashOrder = function hashOrder(order, chainId, exchangeContractAddress) {
  ...
  return hash._TypedDataEncoder.hash(EIP712_DOMAIN, EIP712_TYPES, order);
};
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            msg = new abi.Interface(EIP1271ZeroExDataAbi).encodeFunctionData('OrderWithHash', [order, orderHash]);
            _context3.next = 8;
            return signer.signMessage(bytes.arrayify(msg));
...
var prepareOrderSignatureFromEoaWallet = function prepareOrderSignatureFromEoaWallet(rawSignature) {
  ...
  var signature = bytes.splitSignature(rawSignature);
  return bytes.hexConcat([bytes.hexlify(signature.v), signature.r, signature.s, '0x02']);
};
var prepareOrderSignatureFromContractWallet = function prepareOrderSignatureFromContractWallet(rawSignature) {
  ...
  return bytes.hexConcat([rawSignature, '0x07']);
};
var verifyOrderSignature = function verifyOrderSignature(order, signature, chainId, exchangeContractAddress) {
  ...
  try {
    ...
    var length = bytes.hexDataLength(signature); // Grab the V (exists at index 0 for 0x orders)

    var slicedSigV = bytes.hexDataSlice(signature, 0, 1); // Grab the R and S (index 1 through length - 1 b/c the end hex is the signature type so we strip that too)

    var slicedSig = bytes.hexDataSlice(signature, 1, length - 1);
    var derivedSignatureHex = bytes.hexConcat([slicedSig, slicedSigV]);
    var derivedSignature = bytes.joinSignature(derivedSignatureHex);
    var signer = wallet.verifyTypedData(EIP712_DOMAIN, EIP712_TYPES, order, derivedSignature);
...
var buildOrder = function buildOrder(makerAssets, takerAssets, orderConfig) {
  ...
  if (makerAssetEligibleForSingleAsset) {
    ...
    makerAssetAmount = bignumber.BigNumber.from(getAmountFromAsset(makerAsset));
    ...
    makerAssetAmount = bignumber.BigNumber.from(1); // needs to be 1 for multiasset wrapper amount (actual amounts are nested)
  } // Encode taker assets
  ...
  if (takerAssetEligibleForSingleAsset) {
    ...
    takerAssetAmount = bignumber.BigNumber.from(getAmountFromAsset(takerAsset));
    ...
    takerAssetAmount = bignumber.BigNumber.from(1); // needs to be 1 for multiasset wrapper amount (actual amounts are nested)
  }
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 6:
            ...
            MAX_APPROVAL_WITH_BUFFER = bignumber.BigNumber.from(MAX_APPROVAL.toString()).sub('100000000000000000');
...
var MAX_APPROVAL = /*#__PURE__*/bignumber.BigNumber.from(2).pow(118);
/**
 * @param exchangeProxyAddressForAsset Exchange Proxy address specific to the ERC type (e.g. use the 0x ERC721 Proxy if you're using a 721 asset). This is the address that will need approval & does the spending/swap.
 * @param asset
...
var getSignatureTypeFromSignature = function getSignatureTypeFromSignature(signature) {
  var length = bytes.hexDataLength(signature);
  var signatureType = bytes.hexDataSlice(signature, length - 1);
...
var DEFAUTLT_GAS_BUFFER_MULTIPLES = (_DEFAUTLT_GAS_BUFFER_ = {}, _DEFAUTLT_GAS_BUFFER_[exports.SupportedChainIdsV3.Polygon] = 1.5, _DEFAUTLT_GAS_BUFFER_[exports.SupportedChainIdsV3.PolygonMumbai] = 1.5, _DEFAUTLT_GAS_BUFFER_[exports.SupportedChainIdsV3.Kovan] = 1.5, _DEFAUTLT_GAS_BUFFER_);
  ...
  function NftSwapV3(provider, signer, chainId, additionalConfig) {
                      ...
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          ...
                          case 3:
                            ...
                            if (!(_orderInfo.orderStatus === exports.OrderStatusV3.Fillable)) {
                              _context2.next = 10;
                              break;
                            }
                          ...
                          case 10:
                            if (!(_orderInfo.orderStatus === exports.OrderStatusV3.FullyFilled)) {
                              _context2.next = 14;
                              break;
                            }
    ...
    this.checkIfOrderCanBeFilledWithNativeToken = function (order, wrappedNativeTokenContractAddress) {
      ...
      if (wrappedNativeTokenContractAddress === void 0) {
       ...
       warning(_this.wrappedNativeTokenContractAddress, 'Wrapped native token contract address not set. Cannot determine if order can be filled with native token') ;
      ...
      if (decodedAssetData.assetProxyId.toLowerCase() !== exports.AssetProxyId.ERC20.toLowerCase()) {
        return false;
      ...
      !erc20TokenAddress ?  invariant(false, 'ERC20 token address missing from detected ERC20 asset data')  : void 0;
            ...
            switch (_context10.prev = _context10.next) {
              ...
              case 9:
                ...
                eligibleForNativeTokenFill = _this.checkIfOrderCanBeFilledWithNativeToken(signedOrder);
                 warning(eligibleForNativeTokenFill, "Order ineligible for native token fill, fill will fail.") ;
                !_this.forwarderContractAddress ?  invariant(false, 'Forwarder contract address null, cannot fill order in native token')  : void 0;
    ...
    var zeroExExchangeContractAddress = (_additionalConfig$exc = additionalConfig == null ? void 0 : additionalConfig.exchangeContractAddress) != null ? _additionalConfig$exc : chainDefaultContractAddresses == null ? void 0 : chainDefaultContractAddresses.exchange;
     warning(chainDefaultContractAddresses, "Default contract addresses missing for chain " + this.chainId + ". Supply ExchangeContract and Asset Proxy contracts manually via additionalConfig argument") ;
    this.exchangeContractAddress = zeroExExchangeContractAddress;
    this.erc20ProxyContractAddress = (_additionalConfig$erc = additionalConfig == null ? void 0 : additionalConfig.erc20ProxyContractAddress) != null ? _additionalConfig$erc : getProxyAddressForErcType(exports.SupportedTokenTypes.ERC20, this.chainId);
    this.erc721ProxyContractAddress = (_additionalConfig$erc2 = additionalConfig == null ? void 0 : additionalConfig.erc721ProxyContractAddress) != null ? _additionalConfig$erc2 : getProxyAddressForErcType(exports.SupportedTokenTypes.ERC721, this.chainId);
    this.erc1155ProxyContractAddress = (_additionalConfig$erc3 = additionalConfig == null ? void 0 : additionalConfig.erc1155ProxyContractAddress) != null ? _additionalConfig$erc3 : getProxyAddressForErcType(exports.SupportedTokenTypes.ERC1155, this.chainId);
    ...
    !this.exchangeContractAddress ?  invariant(false, '0x V3 Exchange Contract Address not set. Exchange Contract is required to load NftSwap')  : void 0;
     warning(this.erc20ProxyContractAddress, 'ERC20Proxy Contract Address not set, ERC20 swaps will not work') ;
     warning(this.erc721ProxyContractAddress, 'ERC721Proxy Contract Address not set, ERC721 swaps will not work') ;
     warning(this.erc1155ProxyContractAddress, 'ERC20Proxy Contract Address not set, ERC1155 swaps will not work') ;
     warning(this.forwarderContractAddress, 'Forwarder Contract Address not set, native token fills will not work') ;
     warning(this.wrappedNativeTokenContractAddress, 'WETH Contract Address not set, SDK cannot automatically check if order can be filled with native token') ;
     warning(this.signer, 'No Signer provided; Read-only mode only.') ; // Initialize Exchange contract so we can interact with it easily.
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            // Weird issue with BigNumber and approvals...need to look into it, adding buffer.
            MAX_APPROVAL_WITH_BUFFER = bignumber.BigNumber.from(MAX_APPROVAL$1.toString()).sub('100000000000000000');
            approvedForMax = erc20AllowanceBigNumber.gte(MAX_APPROVAL_WITH_BUFFER);
            return _context2.abrupt("return", {
              contractApproved: approvedForMax
            });
...
var MAX_APPROVAL$1 = /*#__PURE__*/bignumber.BigNumber.from(2).pow(118);
/**
 * @param exchangeProxyAddressForAsset Exchange Proxy address specific to the ERC type (e.g. use the 0x ERC721 Proxy if you're using a 721 asset). This is the address that will need approval & does the spending/swap.
 * @param asset
 * @param signer Signer, must be a signer not a provider, as signed transactions are needed to approve
...
function parseRawSignature(rawSignature) {
  var hexSize = bytes.hexDataLength(rawSignature); // if (hexUtils.size(rpcSig) !== 65) {
  ...
  if (VALID_V_VALUES.includes(v)) {
    ...
    return {
      ...
      r: bytes.hexDataSlice(rawSignature, 0, 32),
      s: bytes.hexDataSlice(rawSignature, 32, 64),
      v: v
    };
  ...
  return {
    v: v,
    r: bytes.hexDataSlice(rawSignature, 1, 33),
    s: bytes.hexDataSlice(rawSignature, 33, 65)
  };
}
var INFINITE_EXPIRATION_TIMESTAMP_SEC = /*#__PURE__*/bignumber.BigNumber.from(2524604400);
...
var verifyAppIdOrThrow = function verifyAppIdOrThrow(appId) {
  ...
  !isCorrectLength ?  invariant(false, 'appId must be 39 digits or less')  : void 0;
  !hasOnlyNumbers ?  invariant(false, 'appId must be numeric only (no alpha or special characters, only numbers)')  : void 0;
};
/**
...
var generateRandomV4OrderNonce = function generateRandomV4OrderNonce(appId) {
  ...
  !(final256BitNonce.length <= TWO_FIFTY_SIX_BIT_LENGTH) ?  invariant(false, 'Invalid nonce size')  : void 0;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            stringifiedQueryParams = queryString.stringify(filters != null ? filters : {}, {
              arrayFormat: 'none'
            });
...
})(exports.TradeDirection || (exports.TradeDirection = {}));
...
})(exports.OrderStatusV4 || (exports.OrderStatusV4 = {}));
/**
 * Buy orders are where direction is set to TradeDirection.BUY_NFT, which indicates that a maker wishes to buy an ERC721 token that they do not possess.
 * Sell orders are orders where direction is set to TradeDirection.SELL_NFT, which indicates that a maker wishes to sell an ERC721 token that they possess.
 */
...
var DIRECTION_MAPPING = (_DIRECTION_MAPPING = {}, _DIRECTION_MAPPING[exports.TradeDirection.BuyNFT] = 'buy', _DIRECTION_MAPPING[exports.TradeDirection.SellNFT] = 'sell', _DIRECTION_MAPPING);
...
})(exports.SupportedChainIdsV4 || (exports.SupportedChainIdsV4 = {}));

var SupportedChainsForV4OrderbookStatusMonitoring = [exports.SupportedChainIdsV4.Ropsten, exports.SupportedChainIdsV4.Polygon, exports.SupportedChainIdsV4.PolygonMumbai, exports.SupportedChainIdsV4.Mainnet, exports.SupportedChainIdsV4.Optimism]; // We may want to see if it is possible to add our chain to the orderbook status monitoring.
...
var NftSwapV4 = /*#__PURE__*/function () {
  function NftSwapV4(provider, signer, chainId, additionalConfig) {
    ...
    this.batchBuyNfts = function (signedOrders, revertIfIncomplete, transactionOverrides) {
      ...
      !allSellOrders ?  invariant(false, "batchBuyNfts: All orders must be of type sell order (order direction == 0)")  : void 0;
      ...
      !eitherAllErc721OrErc1155Orders ?  invariant(false, "Batch buy is only available for tokens of the same ERC type.")  : void 0;
    ...
    this.buildNftAndErc20Order = function (nft, erc20, sellOrBuyNft, makerAddress, userConfig) {
      ...
      var direction = sellOrBuyNft === 'sell' ? exports.TradeDirection.SellNFT : exports.TradeDirection.BuyNFT; // Validate that a bid does not use ETH.

      if (direction === exports.TradeDirection.BuyNFT) {
        ...
        return runtime_1.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                if (!(signedOrder.direction !== exports.TradeDirection.BuyNFT)) {
                  _context4.next = 4;
                  break;
                }
              ...
              case 6:
                ...
                encodingIface = new abi.Interface(ERC721_TRANSFER_FROM_DATA);
              ...
              case 17:
                ...
                _encodingIface = new abi.Interface(ERC1155_TRANSFER_FROM_DATA);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                canOrderTypeBeFilledWithNativeToken = signedOrder.direction === exports.TradeDirection.SellNFT; // Is ERC20 being traded the native token
                ...
                if (!(signedOrder.direction === exports.TradeDirection.SellNFT)) {
                  _context6.next = 9;
                  break;
                }
    ...
    this.postOrder = function (signedOrder, chainId, metadata) {
      ...
      var supportsMonitoring = SupportedChainsForV4OrderbookStatusMonitoring.includes(parsedChainId);
       warning(supportsMonitoring, "Chain " + chainId + " does not support live orderbook status monitoring. Orders can be posted to be persisted, but status wont be monitored (e.g. updating status on a fill, cancel, or expiry.)") ;
    ...
    this.getMakerAsset = function (order) {
      ...
      if (order.direction.toString(10) === exports.TradeDirection.BuyNFT.toString()) {
        return {
          tokenAddress: order.erc20Token,
          amount: order.erc20TokenAmount.toString(10),
          type: 'ERC20'
        };
      } else if (order.direction.toString(10) === exports.TradeDirection.SellNFT.toString()) {
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 9:
                ...
                return _context10.abrupt("return", ethers.BigNumber.from(1));

              case 12:
                return _context10.abrupt("return", ethers.BigNumber.from(0));
    ...
    this.getTotalFees = function (order) {
      ...
      fees.forEach(function (fee) {
        feesTotal = feesTotal.add(ethers.BigNumber.from(fee.amount));
      });
      return feesTotal;
    };
    /**
    ...
    this.getErc20TotalIncludingFees = function (order) {
      ...
      var orderTotalCost = ethers.BigNumber.from(order.erc20TokenAmount).add(feesTotal);
    ...
    !zeroExExchangeContractAddress ?  invariant(false, '0x V4 Exchange Contract Address not set. Exchange Contract is required to load NftSwap')  : void 0;
  ...
  _proto.buildOrder = function buildOrder(makerAsset, takerAsset, makerAddress, orderConfig) {
    ...
    var direction = exports.TradeDirection.SellNFT;

    if (takerAsset.type === 'ERC20') {
      // NFT is on the maker side (so the maker is selling the NFT)
      direction = exports.TradeDirection.SellNFT;
    }

    if (makerAsset.type === 'ERC20') {
      // NFT is on the taker side (so the maker is buying the NFT)
      direction = exports.TradeDirection.BuyNFT;
    }

    var nft = direction === exports.TradeDirection.BuyNFT ? takerAsset : makerAsset;
    var erc20 = direction === exports.TradeDirection.BuyNFT ? makerAsset : takerAsset;
...
exports.DIRECTION_MAPPING = DIRECTION_MAPPING;
exports.EIP1155_DOMAIN_PARAMETERS = EIP1155_DOMAIN_PARAMETERS;
exports.EIP712_DOMAIN_PARAMETERS = EIP712_DOMAIN_PARAMETERS;
exports.EIP712_TYPES = EIP712_TYPES;
exports.ERC1155ORDER_STRUCT_ABI = ERC1155ORDER_STRUCT_ABI;
exports.ERC1155ORDER_STRUCT_NAME = ERC1155ORDER_STRUCT_NAME;
exports.ERC721ORDER_STRUCT_ABI = ERC721ORDER_STRUCT_ABI;
exports.ERC721ORDER_STRUCT_NAME = ERC721ORDER_STRUCT_NAME;
exports.ETH_ADDRESS_AS_ERC20 = ETH_ADDRESS_AS_ERC20;
exports.FEE_ABI = FEE_ABI;
exports.MAX_APPROVAL = MAX_APPROVAL;
exports.NATIVE_TOKEN_ADDRESS_AS_ERC20 = NATIVE_TOKEN_ADDRESS_AS_ERC20;
exports.NftSwap = NftSwapV3;
exports.NftSwapV3 = NftSwapV3;
exports.NftSwapV4 = NftSwapV4;
exports.OrderStatusCodeLookup = OrderStatusCodeLookup;
exports.PROPERTY_ABI = PROPERTY_ABI;
exports.SupportedChainsForV4OrderbookStatusMonitoring = SupportedChainsForV4OrderbookStatusMonitoring;
exports.V3ExchangeContract = ExchangeContract;
exports.V4ExchangeProxy = IZeroEx;
exports.approveAsset = approveAsset;
exports.buildOrder = buildOrder;
exports.cancelOrder = cancelOrder;
exports.cancelOrders = cancelOrders;
exports.cancelOrdersUpToNow = cancelOrdersUpToNow;
exports.checkIfContractWallet = checkIfContractWallet;
exports.convertAssetToInternalFormat = convertAssetToInternalFormat;
exports.convertAssetsToInternalFormat = convertAssetsToInternalFormat;
exports.convertDecodedAssetDataToUserFacingAssets = convertDecodedAssetDataToUserFacingAssets;
...
exports.encodeMultiAssetAssetData = encodeMultiAssetAssetData;
exports.estimateGasForApproval = estimateGasForApproval;
exports.estimateGasForFillOrder = estimateGasForFillOrder;
exports.fillSignedOrder = fillSignedOrder;
exports.getAmountFromAsset = getAmountFromAsset;
exports.getApprovalStatus = getApprovalStatus;
exports.getAssetsFromOrder = getAssetsFromOrder;
exports.getOrderInfo = getOrderInfo;
exports.getOrderStatus = getOrderStatus;
exports.getSignatureTypeFromSignature = getSignatureTypeFromSignature;
exports.hashOrder = hashOrder;
exports.prepareOrderSignatureFromContractWallet = prepareOrderSignatureFromContractWallet;
exports.prepareOrderSignatureFromEoaWallet = prepareOrderSignatureFromEoaWallet;
exports.signOrder = signOrder;
exports.signOrderWithEip1271 = signOrderWithEip1271;
exports.signOrderWithEoaWallet = signOrderWithEoaWallet;
exports.verifyOrderSignature = verifyOrderSignature;
//# sourceMappingURL=nft-swap-sdk.cjs.development.js.map
