...
export declare enum SupportedChainIdsV3 {
    Mainnet = 1,
    Ropsten = 3,
    Rinkeby = 4,
    Kovan = 42,
...
export declare enum OrderStatusV3 {
    Invalid = 0,
...
export declare const OrderStatusCodeLookup: {
    0: string;
    1: string;
    2: string;
    3: string;
...
export declare type AvailableSingleAssetDataTypes = ERC20AssetData | ERC721AssetData | ERC1155AssetData;
export declare type AvailableAssetDataTypes = AvailableSingleAssetDataTypes | MultiAssetData;
...
export declare type UserFacingSerializedSingleAssetDataTypes = UserFacingERC20AssetDataSerialized | UserFacingERC721AssetDataSerialized | UserFacingERC1155AssetDataSerialized;
...
export declare type SerializedSingleAssetDataTypes = ERC20AssetDataSerialized | ERC721AssetDataSerialized | ERC1155AssetDataSerialized;
export declare type SerializedAvailableAssetDataTypes = SerializedSingleAssetDataTypes | MultiAssetDataSerialized;
export interface MultiAssetDataSerializedRecursivelyDecoded {
    assetProxyId: string;
    amounts: string[];
    nestedAssetData: SerializedSingleAssetDataTypes[];
}
export declare type SerializedAvailableAssetDataTypesDecoded = SerializedSingleAssetDataTypes | MultiAssetDataSerializedRecursivelyDecoded;
export declare enum ORDER_BUILDER_ERROR_CODES {
...
export declare type SupportedTokenTypesType = SupportedTokenTypes.ERC20 | SupportedTokenTypes.ERC721 | SupportedTokenTypes.ERC1155;
...
export declare type AvailableTradeableAssets = Erc20TradeableAsset | Erc721TradeableAsset | Erc1155TradeableAsset;
...
export declare type SwappableAsset = UserFacingERC20AssetDataSerialized | UserFacingERC721AssetDataSerialized | UserFacingERC1155AssetDataSerializedNormalizedSingle;
...
export declare type AvailableSignatureTypesV3 = 'eoa' | 'eip1271';
export interface SigningOptionsV3 {
    signatureType: AvailableSignatureTypesV3;
