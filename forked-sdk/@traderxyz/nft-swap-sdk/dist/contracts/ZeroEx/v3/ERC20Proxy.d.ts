...
export interface ERC20ProxyInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: 'addAuthorizedAddress' | 'authorities' | 'removeAuthorizedAddress' | 'owner' | 'removeAuthorizedAddressAtIndex' | 'getProxyId' | 'authorized' | 'getAuthorizedAddresses' | 'transferOwnership'): FunctionFragment;
